...
namespace LibraryManagementSystemProject.Controllers
{
    public class OduncController : Controller
    {
        ...
        public ActionResult OduncIade(TBLHAREKET p)
        {
            ...
            DateTime d1 = DateTime.Parse(odn.IADETARIH.ToString());                //ödünç alınan tarihi DateTime türüne dönüştürme
            DateTime d2 = Convert.ToDateTime(DateTime.Now.ToShortDateString());    //mevcut tarihi alır ve saat, dakika, saniye bilgilerini sıfırlar
            TimeSpan d3 = d2 - d1;
